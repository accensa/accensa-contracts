...
//!
//! When veToken mechanics are enabled, voting power is further multiplied
/// by the time-weighted factor based on lock duration.
...
mod tests {
    ...
    fn test_quadratic_weight_large_deposits() {
        ...
        register_deposit(&env, &member, 10_0000000); // 10 million tokens
